            ...
            with torch.cuda.amp.autocast(enabled=use_amp):
                ...
                # for ind in [0]:  # 只跑 synonym
                    if ind > 0:
                        ...
                        all_skeleton_features.append(feature_dict[self.arg.model_args['head'][0]])
                ...
                logits_image, logits_text = create_logits(
                ...
                loss_fuse=(loss_imgs + loss_texts) / 2

                loss_ce = self.loss_ce(output, label)

                loss = loss_ce + 0.5 * loss_fuse
